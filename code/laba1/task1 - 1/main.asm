...
;      65 // Func7=Out Func6=Out Func5=Out Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
;      66 // State7=0 State6=0 State5=0 State4=0 State3=0 State2=0 State1=0 State0=0
;      67 PORTD=0x00;
	LDI  R30,LOW(0)
	OUT  0x12,R30
;      68 DDRD=0xFF;
...
;      72 // Clock value: Timer 0 Stopped
;      73 // Mode: Normal top=FFh
;      74 // OC0 output: Disconnected
;      75 TCCR0=0x00;
	LDI  R30,LOW(0)
	OUT  0x33,R30
;      76 TCNT0=0x00;
...
;     100 OCR1BL=0x00;
	OUT  0x28,R30
;     101 
;     102 // Timer/Counter 2 initialization
;     103 // Clock source: System Clock
;     104 // Clock value: Timer 2 Stopped
;     105 // Mode: Normal top=FFh
;     106 // OC2 output: Disconnected
;     107 ASSR=0x00;
	OUT  0x22,R30
;     108 TCCR2=0x00;
	OUT  0x25,R30
